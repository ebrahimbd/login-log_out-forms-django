"""
Django settings for studentlogin project.
...
SECRET_KEY = '#1f7ia=5n0q(jc%@holi!e@grzprhc$r3($ok6n3102v9ul1ib'
...
ROOT_URLCONF = 'studentlogin.urls'
...
WSGI_APPLICATION = 'studentlogin.wsgi.application'
